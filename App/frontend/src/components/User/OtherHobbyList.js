...
import HobbiesBox from '../Profile/HobbiesBox';
...
const OtherUserHobbyList = ({ navigation, scrollOffsetY, searchedUser }) => {
  ...
  const fetchData = async () => {
    try {
      setLoadingMore(true);
      const res = await showUsersHobbies(token, searchedUser);
...
export default OtherUserHobbyList;
