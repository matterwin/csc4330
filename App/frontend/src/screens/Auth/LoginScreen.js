      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ width: '100%', display: 'flex', flex: 1 }}>
        <View style={ styles.screenContainer }>
          ...
          <View style={{ marginLeft: 'auto' }}>
            <Text style={[styles.otherBtnText, { fontFamily: FONTS.Poppins_500 }]}>Forgot Password?</Text>
          </View>
          <View style={styles.btnContainer} onTouchStart={handleLogin}>
          ...
          <View style={styles.otherBtnContainer}>
            <View style={[ styles.otherBtn ]}>
              <Icon name="arrow-forward" size={26} color={COLORS.primary} style={{ marginRight: 5 }} />
              <Text style={styles.otherBtnText}>Swipe Left to 
                  <Text style={{ color: COLORS.primary, fontFamily: FONTS.Poppins_700}} onPress={() => navigation.navigate("Register")}> Sign Up</Text>
              </Text>
            </View>
          </View>
        </View>
